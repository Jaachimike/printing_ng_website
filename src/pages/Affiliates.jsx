    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex space-x-6 mb-16">
        ...
        <div>
          ...
          <p className="mb-5">
            Register on Printin.ng and get your referral code that you can share
            to the public on any platform.
          </p>
          <p>
            You can start earning passive income right away anytime the person
            who registers with Printin.ng using your link makes a payment for a
            printing service.
          </p>
        </div>
        {/* Image */}
